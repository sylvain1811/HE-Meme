...
public class SansImage {
  ...
  @Test
  public void testSansImage() throws Exception {
    ...
    driver.findElement(By.id("j_idt23:title")).sendKeys("test");
    driver.findElement(By.id("j_idt23:categoryId")).click();
    new Select(driver.findElement(By.id("j_idt23:categoryId"))).selectByVisibleText("Animals");
